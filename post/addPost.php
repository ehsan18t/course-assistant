...
<?php require_once INCLUDES['nav-logged-template']; ?>
    <div >
        <h2><a href="index.php">POST FILE</a></h2>
        <?php //if(isset($delmsg)){
            //echo $delmsg;
        //} ?>
        <form action="" method="post" enctype="multipart/form-data">
        <?php if(isset($upload_lmsg)){echo $upload_lmsg;} ?>
            <input  type="text" name="course_code" placeholder="Enter Course Code" require>
            <input  type="text" name="course_name" placeholder="Enter Course Name" require>
            <input type="text" name="course_des" placeholder="Description" require>
            <label for="file">Upload Your Files</label>
            <input  type="file" name="course_file" require >
        ...
        <table>
            ...
            <?php while($post=mysqli_fetch_assoc($posts)){ ?>
                <tr>
                    ...
                    <td>
                        <a href="editPost.php?status=edit&&id=<?php echo $post['p_id']; ?>">Edit</a>
